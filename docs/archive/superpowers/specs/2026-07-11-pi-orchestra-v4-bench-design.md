...
**Execution handoff:** `docs/archive/prompts/2026-07-11-v4-phase2-next-session.md`
**Completed prereq:** the three ordered fixes in
`docs/archive/reviews/2026-07-11-v3-rust-review.md` landed in Phase 0; the embedded-PTY
...
`docs/archive/notes/2026-07-11-tui-spike.md`. **Fallback if PTY embedding fails
...
(worktree-isolated); friction log in `docs/archive/notes/` is a deliverable.
