...
**Spec:** `docs/archive/superpowers/specs/2026-07-28-harness-registration-design.md`. **Issue:** #33.
...
gh pr create --repo Legend101Zz/Agent-orchestra \
  ...
  --body "Closes #33. See docs/archive/superpowers/specs/2026-07-28-harness-registration-design.md for the design."
```
