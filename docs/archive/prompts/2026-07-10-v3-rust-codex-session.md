...
- **Registry compatibility is sacred**: `~/.orchestra/runs/<id>/{meta.json,
  ...
  still render.
- Read first: `README.md`, `docs/archive/guide.html`,
  `docs/archive/superpowers/specs/2026-07-10-pi-orchestra-design.md`, and skim
...
`docs/archive/superpowers/specs/2026-07-11-orc-v3-rust-design.md` (features, Rust
...
`docs/archive/notes/2026-07-11-codex-orchestrate-friction.md` — the judge will read it.
