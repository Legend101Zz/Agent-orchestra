...
Read `README.md` and `docs/archive/superpowers/specs/2026-07-10-pi-orchestra-design.md` first.
...
- Generate SVG screenshots of the new dashboard AND a session detail screen via
  ...
  `orc-session-screenshot.svg`); update `README.md` and `docs/archive/guide.html` references.
