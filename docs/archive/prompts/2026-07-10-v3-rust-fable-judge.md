...
Read the branch's spec (`docs/archive/superpowers/specs/*orc-v3*`), then verify claims
...
- Read `docs/archive/notes/*codex-orchestrate-friction*`. Where the flow fought the brain,
...
Write `docs/archive/reviews/2026-07-11-v3-rust-review.md` on the branch:
