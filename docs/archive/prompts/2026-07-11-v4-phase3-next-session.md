...
4. Read completely, in this order:
   - `docs/archive/superpowers/specs/2026-07-11-pi-orchestra-v4-bench-design.md`
   - `docs/archive/notes/2026-07-11-v4-phase2-evidence.md`
   - `docs/archive/reviews/2026-07-11-v3-rust-review.md`, especially the five skill
     wording fixes
   - `progress.md`, `task_plan.md`, README, and `docs/archive/guide.html`
...
- Apply all five concrete wording fixes from
  `docs/archive/reviews/2026-07-11-v3-rust-review.md`: brain-correct attribution plus
...
Write `docs/archive/notes/2026-07-11-v4-phase3-evidence.md` with exact commands and
