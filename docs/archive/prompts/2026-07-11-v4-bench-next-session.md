...
`docs/archive/prompts/2026-07-11-v4-phase2-next-session.md`.
...
`docs/archive/superpowers/specs/2026-07-11-pi-orchestra-v4-bench-design.md`; read it
...
1. `docs/archive/reviews/2026-07-11-v3-rust-review.md` — fix-first verdict; findings
   1–3 (+6) are your Phase 0.
2. `docs/archive/superpowers/specs/2026-07-11-orc-v3-rust-design.md` — inherited
   constraints (atomic registry, tolerant models, fail-open quota, no-emoji /
   theme-token discipline).
3. `docs/archive/notes/2026-07-11-codex-orchestrate-friction.md` — dogfood lessons.
...
Verdict to `docs/archive/notes/2026-07-11-tui-spike.md`. **Fallback if PTY fidelity
...
tasks on the SCORE; keep a friction log in `docs/archive/notes/` — it is a
deliverable.
