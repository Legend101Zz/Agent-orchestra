...
the push, a Claude session reviews adversarially per `WORKFLOW.md` prompt 2.
...
entry), task_plan.md, an evidence note under docs/archive/notes/, and findings.md for any durable
...
- Evidence: `docs/archive/notes/2026-08-01-issue-49-phase3-evidence.md`. Durable
