...
captures under `docs/archive/notes/2026-07-13-phase6b-captures/`.
...
Live tmux smokes (captures in `docs/archive/notes/2026-07-13-phase6c-captures/`):
...
`docs/archive/media/home-flow.png` (new cwd step), `docs/archive/media/home-shelf.png` (shelf card
showing `2/2 workers live · READY` for the real session).
`docs/archive/media/score-board.png` is unchanged from Session 8: the SCORE change only
...
Real tmux smokes of every user-visible fix, captures under `docs/archive/notes/`:
