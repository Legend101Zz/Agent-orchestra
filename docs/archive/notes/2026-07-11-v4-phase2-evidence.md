...
- `docs/archive/media/v4-phase2-shell.gif`: HOME, three-step flow, wide ember STAGE,
  zoom/swap, detach, and reattach.
- `docs/archive/media/v4-phase2-narrow-phosphor.gif`: flow and STAGE at exactly 72×30 in
